...
This library is forked from [machine-runner](https://github.com/Actyx/machines/tree/master/machine-runner) by [Actyx AG](https://github.com/Actyx) and offers a TypeScript DSL for writing state machines and executing them in a fully decentralised fashion using the [Actyx](https://developer.actyx.com/) peer-to-peer event stream database.
