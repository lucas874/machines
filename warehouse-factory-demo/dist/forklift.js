...
exports.s1 = forklift.designState('s1').withPayload()
    .command('get', [factory_protocol_1.Events.pos], (state, _) => {
    console.log("retrieved a", state.self.id, "at position x");
    return [factory_protocol_1.Events.pos.make({ position: "x", part: state.self.id })];
})
    .finish();
exports.s2 = forklift.designEmpty('s2').finish();
exports.s0.react([factory_protocol_1.Events.partReq], exports.s1, (_, e) => {
...
exports.s1.react([factory_protocol_1.Events.pos], exports.s0, (_) => exports.s0.make());
