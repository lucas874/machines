...
const transporter = protocol_1.Composition.makeMachine('T');
exports.s0 = transporter.designEmpty('s0')
    .command('request', [protocol_1.Events.partReq], (s, e) => {
    var id = parts[Math.floor(Math.random() * parts.length)];
    console.log("requesting a", id);
    return [protocol_1.Events.partReq.make({ id: id })];
})
    .finish();
exports.s1 = transporter.designEmpty('s1').finish();
exports.s2 = transporter.designState('s2').withPayload()
    .command('deliver', [protocol_1.Events.partOK], (s, e) => {
    console.log("delivering a", s.self.part);
    return [protocol_1.Events.partOK.make({ part: s.self.part })];
})
    .finish();
exports.s3 = transporter.designEmpty('s3').finish();
exports.s0.react([protocol_1.Events.partReq], exports.s1, (_) => exports.s1.make());
exports.s0.react([protocol_1.Events.closingTime], exports.s3, (_) => exports.s3.make());
exports.s1.react([protocol_1.Events.pos], exports.s2, (_, e) => {
    console.log("got a ", e.payload.part);
    return { part: e.payload.part };
});
exports.s2.react([protocol_1.Events.partOK], exports.s0, (_, e) => { return exports.s0.make(); });
// Projection of Gwarehouse || Gfactory || Gquality over T
const projectionInfoResult = (0, machine_check_1.projectionAndInformation)(protocol_1.interfacing_swarms, protocol_1.subs, "T");
if (projectionInfoResult.type == 'ERROR')
    throw new Error('error getting projection');
const projectionInfo = projectionInfoResult.data;
// Adapted machine
const [transporterAdapted, s0_] = protocol_1.Composition.adaptMachine("T", projectionInfo, protocol_1.Events.allEvents, exports.s0);
const checkProjResult = (0, machine_check_1.checkComposedProjection)(protocol_1.interfacing_swarms, protocol_1.subs, "T", transporterAdapted.createJSONForAnalysis(s0_));
