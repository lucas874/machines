...
exports.s0 = transporter.designEmpty('s0')
    .command('request', [factory_protocol_1.Events.partReq], (s, e) => {
    var id = parts[Math.floor(Math.random() * parts.length)];
    console.log("requesting a", id);
    return [factory_protocol_1.Events.partReq.make({ id: id })];
})
    .finish();
exports.s1 = transporter.designEmpty('s1').finish();
exports.s2 = transporter.designState('s2').withPayload()
    .command('deliver', [factory_protocol_1.Events.partOK], (s, e) => {
    console.log("delivering a", s.self.part);
    return [factory_protocol_1.Events.partOK.make({ part: s.self.part })];
})
    .finish();
exports.s3 = transporter.designEmpty('s3').finish();
exports.s0.react([factory_protocol_1.Events.partReq], exports.s1, (_) => exports.s1.make());
exports.s0.react([factory_protocol_1.Events.closingTime], exports.s3, (_) => exports.s3.make());
exports.s1.react([factory_protocol_1.Events.pos], exports.s2, (_, e) => {
    console.log("got a ", e.payload.part);
    return { part: e.payload.part };
});
exports.s2.react([factory_protocol_1.Events.partOK], exports.s0, (_, e) => { return exports.s0.make(); });
