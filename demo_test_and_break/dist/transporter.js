...
const result_projection_info = (0, machine_check_1.projectionAndInformation)(factory_protocol_1.interfacing_swarms, factory_protocol_1.subs, "T");
...
// Extended machine
const [m3, i3] = factory_protocol_1.Composition.extendMachineBT("T", projection_info, factory_protocol_1.Events.allEvents, fMap, exports.s0);
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const machine = (0, machine_runner_1.createMachineRunnerBT)(app, tags, exports.s0, { id: parts[Math.floor(Math.random() * parts.length)] });
        try {
