...
const result_projection_info = projectionAndInformation(interfacing_swarms, sub, "R")
...
// Extend machine
const [m3, i3] = Composition.extendMachineBT("R", projection_info, Events.allEvents, fMap, s0)
