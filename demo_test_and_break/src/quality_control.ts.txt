...
const result_projection_info = projectionAndInformation(interfacing_swarms, subs, "QCR")
...
cMap.set(Events.report.type, (s: any, _: any) => {
    ...
    //return [Events.report.make({modelName: s.self.modelName, decision: s.self.decision})]})
cMap.set(Events.observing.type, (s: any, e: any) => {
    console.log("began observing");
...
// Extended machine
const [m3, i3] = Composition.extendMachineBT("QCR", projection_info, Events.allEvents, fMap, qcr)
