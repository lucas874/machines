...
const result_sub = (0, machine_check_1.overapproxWWFSubscriptions)(warehouse_protocol_1.interfacing_swarms, {}, 'Medium');
...
const checkResult = (0, machine_check_1.checkWWFSwarmProtocol)(warehouse_protocol_1.interfacing_swarms, exports.sub);
...
const robot = warehouse_protocol_1.Composition.makeMachine('R');
exports.s0 = robot.designEmpty('s0').finish();
exports.s1 = robot.designState('s1').withPayload()
    .command("build", [warehouse_protocol_1.Events.car], (s, _) => {
    var modelName = s.self.part === 'spoiler' ? "sports car" : "sedan";
    console.log("using the ", s.self.part, " to build a ", modelName);
    return [warehouse_protocol_1.Events.car.make({ part: s.self.part, modelName: modelName })];
})
    .finish();
exports.s2 = robot.designEmpty('s2').finish();
exports.s0.react([warehouse_protocol_1.Events.part], exports.s1, (_, e) => {
    console.log("received a ", e.payload.part);
    return exports.s1.make({ part: e.payload.part });
});
exports.s1.react([warehouse_protocol_1.Events.car], exports.s2, (_) => exports.s2.make());
// Projection of Gwarehouse || Gfactory || Gquality over R
const result_projection = (0, machine_check_1.projectCombineMachines)(warehouse_protocol_1.interfacing_swarms, exports.sub, "R");
if (result_projection.type == 'ERROR')
    throw new Error('error getting projection');
const projection = result_projection.data;
// Command map
const cMap = new Map();
cMap.set(warehouse_protocol_1.Events.car.type, (s, _) => {
    var modelName = s.self.part === "spoiler" ? "sports car" : "sedan";
    console.log("using the ", s.self.part, " to build a ", modelName);
    return [warehouse_protocol_1.Events.car.make({ part: s.self.part, modelName: modelName })];
});
...
// Extend machine
const [m3, i3] = warehouse_protocol_1.Composition.extendMachine("R", projection, warehouse_protocol_1.Events.allEvents, fMap);
// Check machine (for demonstration purposes)
const checkProjResult = (0, machine_check_1.checkComposedProjection)(warehouse_protocol_1.interfacing_swarms, exports.sub, "R", m3.createJSONForAnalysis(i3));
            ...
            for (var _d = true, machine_1 = __asyncValues(machine), machine_1_1; machine_1_1 = yield machine_1.next(), _a = machine_1_1.done, !_a; _d = true) {
                ...
                for (var c in s.commands()) {
                    if (c === 'build') {
                        ...
                        }, (0, warehouse_protocol_1.getRandomInt)(4000, 8000));
                        break;
                    }
                }
            }
