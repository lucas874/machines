...
const [forkliftAdapted, s0Adapted] = Composition.adaptMachine('Forklift', 'FL', warehouse_protocol, subs_warehouse, 0, forklift.createJSONForAnalysis(s0), s0, true).data!
