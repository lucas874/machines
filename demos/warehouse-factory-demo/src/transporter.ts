...
import { Events, manifest, Composition, printState, warehouse_factory_protocol, subs_composition, warehouse_protocol, subs_warehouse, getRandomInt } from './protocol'
...
// Adapted machine
const [transportAdapted, s0Adapted] = Composition.adaptMachine('T', warehouse_factory_protocol, 0, subs_composition, [transporter, s0], true).data!
