...
import { Events, manifest, Composition, warehouse_factory_protocol, subs_composition, warehouse_protocol, subs_warehouse, printState, getRandomInt } from './protocol'
...
// Adapted machine
const [doorAdapted, s0Adapted] = Composition.adaptMachine('D', warehouse_factory_protocol, subs_composition, 0, [door, s0], true).data!
