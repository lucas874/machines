...
export const [warehouseAdapted, warehouseInitialAdapted] = Composition.adaptMachine('warehouse', [warehouseProtocol, factoryProtocol], 0, subscriptions, [TransportOrderForWarehouse, InitialWarehouse], true).data!
