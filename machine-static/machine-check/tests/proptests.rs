use machine_check::{
    ...
    exact_well_formed_sub, overapproximated_well_formed_sub, project_combine, revised_projection}, well_formed_sub, EdgeId, Graph, MachineType, NodeId, Subscriptions, SwarmProtocolType
};
use machine_types::types::typescript_types::{CheckResult, Command, DataResult, EventType, MachineLabel, Role, State, StateName, SwarmLabel, Transition};
use petgraph::{
    graph::EdgeReference,
