...
use machine_core::types::typescript_types::{
    ...
    SubscriptionsWrapped, SwarmProtocolType,
};
...
fn benchmark_input_to_simple_input(
...
fn wrap_and_write_sub_out_simple(
